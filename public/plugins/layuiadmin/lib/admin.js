...
;layui.define("view", function (e) {
        ...
        x = "layui-icon-spread-left", C = "layadmin-side-shrink", k = "LAY-system-side-menu", P = {
            v: "1.2.1 std", req: l.req, exit: l.exit, escape: function (e) {
                ...
                var i, t = e.seconds, n = a(e.elem), l = function (a) {
                    t--, t < 0 ? (n.removeClass(f).html("鑾峰彇楠岃瘉鐮�"), t = e.seconds, clearInterval(i)) : n.addClass(f).html(t + "绉掑悗閲嶈幏"), a || (i = setInterval(function () {
                        l(!0)
                    }, 1e3))
                };
                e.elemPhone = a(e.elemPhone), e.elemVercode = a(e.elemVercode), n.on("click", function () {
                    ...
                    if (t === e.seconds && !a(this).hasClass(f)) {
                        if (!/^1\d{10}$/.test(n)) return i.focus(), layer.msg("璇疯緭鍏ユ纭殑鎵嬫満鍙�");
            ...
            flexible: function (e) {
                ...
                e.off("keypress").on("keypress", function (a) {
                    if (this.value.replace(/\s/g, "") && 13 === a.keyCode) {
                        var i = e.attr("lay-action"), t = e.attr("lay-text") || "鎼滅储";
                ...
                F.note.index = P.popup({
                    ...
                    success: function (e, a) {
                        var t = e.find("textarea"),
                            l = void 0 === i ? "渚跨涓殑鍐呭浼氬瓨鍌ㄥ湪鏈湴锛岃繖鏍峰嵆渚夸綘鍏虫帀浜嗘祻瑙堝櫒锛屽湪涓嬫鎵撳紑鏃讹紝渚濈劧浼氳鍙栧埌涓婁竴娆＄殑璁板綍銆傛槸涓潪甯稿皬宸у疄鐢ㄧ殑鏈湴澶囧繕褰�" : i;
    ...
    !function () {
        ...
        e.theme ? P.theme(e.theme) : n.theme && P.initTheme(n.theme.initColorIndex), "pageTabs" in layui.setter || (layui.setter.pageTabs = !0), n.pageTabs || (a("#LAY_app_tabs").addClass(c), u.addClass("layadmin-tabspage-none")), s.ie && s.ie < 10 && l.error("IE" + s.ie + "涓嬭闂彲鑳戒笉浣筹紝鎺ㄨ崘浣跨敤锛欳hrome / Firefox / Edge 绛夐珮绾ф祻瑙堝櫒", {
            offset: "auto",
            id: "LAY_errorIE"
        })
